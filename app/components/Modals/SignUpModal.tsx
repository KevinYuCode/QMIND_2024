...
export default function SignUpModal({ closeFunction } : any) {
    ...
    return (
        <>
        { showSignIn ? 
            <SignInModal closeFunction={closeFunction}></SignInModal>
            :
            <DefaultModal>
                ...
                <form className="flex flex-col justify-around items-start w-full" onSubmit={handleSignUp}>
                    
                    <label>First Name</label>
                    <TextInput id="firstName" required={true} onChange={(event: any) => setFirstName(event.target.value)}/>

                    <label>Last Name</label>
                    <TextInput id="lastName" required={true} onChange={(event: any) => setLastName(event.target.value)}/>

                    <label>Email</label>
                    <TextInput id="email" required={true} onChange={(event: any) => setEmail(event.target.value)}/>

                    <label>Password</label>
                    <TextInput id="password" password={true} required={true} onChange={(event: any) => setPassword(event.target.value)}/>
