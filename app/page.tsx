    ...
    <main className="flex flex-col gap-16 md:gap-20 w-full min-h-[100vh] py-[3rem] 2xl:py-[5rem] relative">
      ...
      <ContentContainer>
          ...
          <div className="flex w-[100%] gap-[37px]">
            ...
            <div
              className={`${styles.yellowCard} rounded-[17px] w-[100%] max-w-[768px] h-[180px] font-family: Kontrapunkt; flex flex-col justify-center items-start pl-[50px] leading-[50px]`}
            >
              <p className="lg:text-[65px] md:text-[45px]">230+</p>
              <p className="lg:text-[32px] md:text-[25px]">
                Software Developers
              </p>
            </div>
            <div
              className={`${styles.redCard}  rounded-[17px] w-[100%] max-w-[320px] h-[180px] font-family: Kontrapunkt; flex flex-col justify-center items-end pr-[50px] leading-[50px]`}
            >
              <p className="lg:text-[65px] md:text-[45px]">200+</p>
              <p className="text-[32px] md:text-[22px]">AI papers & Projects</p>
            </div>
          </div>
          ...
          {/* <div className="flex w-[100%] gap-[37px] ">
            ...
            >
              ...
              <p className="lg:text-[32px] md:text-[18px]">
                Delegates at CUCAI
              </p>
            </div>
            ...
            >
              ...
              <p className="lg:text-[32px] md:text-[18px]">Industry Clients</p>
            </div>
            ...
            >
              ...
              <p className="lg:text-[32px] md:text-[18px]">Tech Articles</p>
            </div>
          </div> */}
          ...
          {/* <div className="flex w-[100%] gap-[37px] ">
            ...
            >
              ...
              <p className="lg:text-[32px] md:text-[22px]">Projects in 2023</p>
            </div>
            <div
            ...
            >
              ...
              <p className="lg:text-[32px] md:text-[22px]">
